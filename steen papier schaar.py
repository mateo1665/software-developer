...
countermoves = []
speler_keuze = input("wat kies je r = rock s = sissors p = paper.")
if moeilijkheid == 'onmogelijk':
   if speler_keuze == 'r':
      keuze_computer = 'p'
   elif speler_keuze == 'p':
...
if speler_keuze in keuzes:
   ...
   if speler_keuze == keuze_computer:
      print('gelijkspel')
   elif (speler_keuze == 'r' and keuze_computer == 's') or (speler_keuze == 's' and keuze_computer == 'p') or (speler_keuze == 'p' and keuze_computer == 'r'):
