...
if naam == 'peet':
    raise NameError('peet is niet welkom')
...
if hoed == 'nee':
    raise TypeError('waarom heb je geen hoed')
...
if certificaat == 'nee':
    raise TypeError('wil je anders dood')
